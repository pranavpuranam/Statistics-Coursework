...
X2 | X1 = x1 ~ N(mu2 + sigma2/sigma1 * rho * (x1 - mu1), (1 - rho**2) * sigma2**2) = N(1 - x/2, 7/2)
"""
...
y_line = alpha_hat + beta_hat * x_line # create fitted line
...
plt.xlabel(xname)
plt.ylabel("PM10")
plt.show() # linear regression model plot
...
y_hat = alpha_hat + beta_hat * x # fitted values
residuals = y - y_hat
